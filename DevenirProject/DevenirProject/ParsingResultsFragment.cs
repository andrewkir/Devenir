...
{
    public class ParsingResultsFragment : Android.Support.V4.App.Fragment
    {
        ImageView imageView;
        ViewPager pager;
        TabLayout tabLayout;
        ...
        public ParsingResultsFragment(Bitmap sourceImage, string[] textProcessed, string[] latexProcessed)
        {
        ...
        class PagesAdapter : Android.Support.V4.App.FragmentPagerAdapter
        {
            ...
            public override Android.Support.V4.App.Fragment GetItem(int position)
            {
                ...
                {
                    case 0:
                        return new ParsingDetailsResultsFragment("Результат работы", textProcessed.Length >= 1 ? textProcessed[0] : null, latexProcessed.Length >= 1 ? latexProcessed[0] : null);
                    case 1:
                        return new ParsingDetailsResultsFragment("Результат анализа 1 фрагмента", textProcessed.Length >= 2 ? textProcessed[1] : null, latexProcessed.Length >= 2 ? latexProcessed[1] : null);
                    case 2:
                        return new ParsingDetailsResultsFragment("Результат анализа 2 фрагмента", textProcessed.Length >= 3 ? textProcessed[2] : null, latexProcessed.Length >= 3 ? latexProcessed[2] : null);
                    case 3:
                        return new ParsingDetailsResultsFragment("Результат анализа 3 фрагмента", textProcessed.Length >= 4 ? textProcessed[3] : null, latexProcessed.Length >= 4 ? latexProcessed[3] : null);
                    default:
                        return new ParsingDetailsResultsFragment("Результат работы", textProcessed.Length >= 1 ? textProcessed[0] : null, latexProcessed.Length >= 1 ? latexProcessed[0] : null);
                }
            }
